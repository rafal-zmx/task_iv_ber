...
int main()
{
	...
	while (CzyWyjsc)
	{
		...
		{
			system("cls");
			cout << "1. Test 1: Przygotuj dwa identyczne pliki zawierajšce binarnie zapisana\n   wartosc 0x55. Kazdy plik po 100 Bajtow." << endl;
		...
		{
			system("cls");
			cout << "2. Test 2: Przygotuj dwa pliki kazdy po 100 bajtow.Pierwszy zawiera \n   binarnie zapisana wartosc 0x55. Drugi plik rozni się od pierwszego o dowolne 10 bitow." << endl;
